...
The features of KNN and LR were also scaled because they depend on distances and coefficient magnitudes. The scaling is important because it ensures that features with larger numerical ranges do not disproportionately influence the models' behavior.
